 ...
 */
public class DrawerDataAdapter extends RecyclerView.Adapter<DrawerDataAdapter.ViewHolder> {
    ...
    @Override
    public DrawerDataAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(DrawerDataAdapter.ViewHolder holder, int position) {
