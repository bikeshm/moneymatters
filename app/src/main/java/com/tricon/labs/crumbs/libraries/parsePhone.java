...
public class parsePhone {
    ...
    public static String parsePhone(String phone, String countryCode ) {
        PhoneNumberUtil phoneUtil = PhoneNumberUtil.getInstance();
        try {
            Phonenumber.PhoneNumber numberProto = phoneUtil.parse(phone, countryCode.toUpperCase()); //Locale.getDefault().getCountry()
